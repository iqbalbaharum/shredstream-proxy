...
const (
	TradeType_UNKNOWN              TradeType = 0
	TradeType_PUMPFUN_BUY          TradeType = 1
	TradeType_PUMPFUN_SELL         TradeType = 2
	TradeType_PUMPFUN_BUY_EXACT_IN TradeType = 3
	TradeType_AXIOM_BUY            TradeType = 4
	TradeType_AXIOM_SELL           TradeType = 5
)
...
type SubscribeParsedRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Filter types: ALL, PUMPFUN, AXIOM
...
const file_shredstream_proto_rawDesc = "" +
	...
	"\x17SubscribeEntriesRequest\"0\n" +
	"\x16SubscribeParsedRequest\x12\x16\n" +
	"\x06filter\x18\x01 \x01(\tR\x06filter\"5\n" +
	"\x05Entry\x12\x12\n" +
	"\x04slot\x18\x01 \x01(\x04R\x04slot\x12\x18\n" +
	"\aentries\x18\x02 \x01(\fR\aentries\"\xb5\x02\n" +
	...
	"\ttimestamp\x18\t \x01(\x04R\ttimestamp*t\n" +
	"\tTradeType\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x0f\n" +
	"\vPUMPFUN_BUY\x10\x01\x12\x10\n" +
	"\fPUMPFUN_SELL\x10\x02\x12\x18\n" +
	"\x14PUMPFUN_BUY_EXACT_IN\x10\x03\x12\r\n" +
	"\tAXIOM_BUY\x10\x04\x12\x0e\n" +
	"\n" +
	"AXIOM_SELL\x10\x05*F\n" +
	"\x06Origin\x12\x16\n" +
...
var file_shredstream_proto_goTypes = []any{
	...
	(*Entry)(nil),                        // 8: shredstream.Entry
	(*ParsedTransaction)(nil),            // 9: shredstream.ParsedTransaction
...
var file_shredstream_proto_depIdxs = []int32{
	...
	8,  // 8: shredstream.ShredstreamProxy.SubscribeEntries:output_type -> shredstream.Entry
	9,  // 9: shredstream.ShredstreamProxy.SubscribeParsedTransactions:output_type -> shredstream.ParsedTransaction
